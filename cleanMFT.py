...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', '--filter-index', action = 'store', dest='index_values', help='Enter the index values that you would like to include in the table separated by a space.'
