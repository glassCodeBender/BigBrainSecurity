...
trait Setup {
	...
	/**
		...
		*/
	def getConfig(configFileName: String): Map[String, Some[String]] = {

		/* Stores location of the config file for program*/
		val configLoc = configFileName
    ...
    /* compares hash value of past and current config file. Returns boolean. */
		val configIntegrityCheck: Boolean = checkConfigIntegrity(configLoc)
	...
	private def checkConfigIntegrity(configLoc: String): Boolean = {
